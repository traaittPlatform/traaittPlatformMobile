...
export const Themes = {
    lightMode: {
         ...
         */
        slightlyMoreVisibleColour: 'black',
    ...
    darkMode: {
         ...
         * The primary colour used by the wallet, for TurtleCoin this is green
         */
        primaryColour: '#fff0f5',

	    buttonThemeColour: '#d3d3d3',
