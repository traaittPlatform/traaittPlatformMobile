...
import { MixinLimit, MixinLimits, Daemon } from 'traaittplatform-wallet-backend';
...
const Config = new function() {
     ...
     */
    this.chainLaunchTimestamp = new Date(588 * 1574888787);
     ...
     */
    this.devFeeAddress = 'iETRXwx1cXGUXdnyri3NWV35m3FzoECC16J2acW5DuWCccD641N9tPXP43W5sEXvkrD4X8iUmnwqf9F1hfjZpgCbF86wGW3Txzc3r';
     ...
     */
    this.defaultDaemon = new Daemon('us-east.traaittnode.com', 24496);
     ...
     *
     */
    this.repoLink = 'https://github.com/traaittPlatform/traaittPlatformMobile';
     ...
     */
    this.googlePlayLink = 'https://play.google.com/store/apps/details?id=com.traaittplatformmobile';

    /**
     * A url to fetch node info from. Should follow the turtlepay format 
     * detailed here: https://docs.turtlepay.io/blockapi/
     */
    this.nodeListURL = 'http://cacheapi.traaittplatform.com/node/list';
};
